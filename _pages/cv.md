...
<div class="text-center" style="text-align: center;">
  <div class="row" style="display: flex; justify-content: center;">
    <div style="width: 210px; height: 100px; border: 2px solid rgba(0, 0, 0, 0.5); border-radius: 30%; overflow: hidden; display: flex; align-items: center; justify-content: center; margin-right: 60px;">
    ...
    <div style="width: 210px; height: 100px; border: 2px solid rgba(0, 0, 0, 0.5); border-radius: 30%; overflow: hidden; display: flex; align-items: center; justify-content: center;">
